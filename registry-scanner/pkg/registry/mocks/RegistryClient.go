...
// NewRepository provides a mock function with given fields: ctx, nameInRepository
func (_m *RegistryClient) NewRepository(ctx context.Context, nameInRepository string) error {
	ret := _m.Called(ctx, nameInRepository)
...
func (_m *RegistryClient) Referrers(ctx context.Context, dgst digest.Digest) ([]v1.Descriptor, error) {
	ret := _m.Called(ctx, dgst)
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, digest.Digest) ([]v1.Descriptor, error)); ok {
		return rf(ctx, dgst)
	}
	if rf, ok := ret.Get(0).(func(context.Context, digest.Digest) []v1.Descriptor); ok {
		r0 = rf(ctx, dgst)
	} else {
		if ret.Get(0) != nil {
