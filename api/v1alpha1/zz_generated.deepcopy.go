...
func (in *ApplicationRef) DeepCopyInto(out *ApplicationRef) {
	*out = *in
	...
	if in.CommonSettings != nil {
		in, out := &in.CommonSettings, &out.CommonSettings
...
func (in *ImageApplicationLastUpdated) DeepCopy() *ImageApplicationLastUpdated {
	...
	out := new(ImageApplicationLastUpdated)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ImageConfig) DeepCopyInto(out *ImageConfig) {
	*out = *in
	...
	if in.ManifestTargets != nil {
		in, out := &in.ManifestTargets, &out.ManifestTargets
...
func (in *ImageStatus) DeepCopyInto(out *ImageStatus) {
	*out = *in
	if in.Applications != nil {
		...
		*out = make([]ImageApplicationLastUpdated, len(*in))
		for i := range *in {
...
func (in *ImageUpdaterSpec) DeepCopyInto(out *ImageUpdaterSpec) {
	*out = *in
	if in.GlobalCommonUpdateSettings != nil {
		in, out := &in.GlobalCommonUpdateSettings, &out.GlobalCommonUpdateSettings
		*out = new(CommonUpdateSettings)
		(*in).DeepCopyInto(*out)
	}
	if in.WriteBack != nil {
