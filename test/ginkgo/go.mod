...
require (
	...
	github.com/argoproj/argo-cd/v3 v3.4.8
...
replace (
	...
	// argo-cd v3.4.8 declares gitops-engine at a pseudo-version where go.mod
	// didn't exist yet, then overrides with replace => ./gitops-engine locally.
	// Downstream consumers must resolve it themselves; pin to the v3.4.8 commit.
	github.com/argoproj/argo-cd/gitops-engine => github.com/argoproj/argo-cd/gitops-engine v0.0.0-20260827090322-609fa82ba26d
