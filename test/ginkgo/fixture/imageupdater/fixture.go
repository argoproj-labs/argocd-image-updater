...
//      containers:
//      - Name: git-http
//        image: 127.0.0.1:30000/git-http:latest
...
// The service exposes ports 8080 (unauthenticated) and 8081 (authenticated) as NodePorts
// 30002 and 30003 respectively, allowing external access to the git server.
