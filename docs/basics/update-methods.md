...
target (`.argocd-source-<appName>.yaml`) is used automatically. The file will
contain plugin env var overrides in a format that Argo CD merges into the
Application source at sync time:
