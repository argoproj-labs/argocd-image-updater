...
func (_m *ArgoCD) GetApplication(ctx context.Context, appNamespace string, appName string) (*v1alpha1.Application, error) {
...
// ListApplications provides a mock function with given fields: ctx, cr, labelSelector
func (_m *ArgoCD) ListApplications(ctx context.Context, cr *apiv1alpha1.ImageUpdater, labelSelector string) ([]v1alpha1.Application, error) {
	ret := _m.Called(ctx, cr, labelSelector)
	...
	var r0 []v1alpha1.Application
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *apiv1alpha1.ImageUpdater, string) ([]v1alpha1.Application, error)); ok {
		return rf(ctx, cr, labelSelector)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *apiv1alpha1.ImageUpdater, string) []v1alpha1.Application); ok {
		r0 = rf(ctx, cr, labelSelector)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]v1alpha1.Application)
		}
	...
	if rf, ok := ret.Get(1).(func(context.Context, *apiv1alpha1.ImageUpdater, string) error); ok {
		r1 = rf(ctx, cr, labelSelector)
	} else {
		r1 = ret.Error(1)
	}
